...
export const ACTION_SET_IS_FILTERS_VISIVLE='SET_IS_FILTERS_VISIVLE';
...
export  function toggleOrdeType(){
    return (dispatch,getState)=>{
...
export  function setTicketTypes(tickTypes){
    return{
...
export  function toggleIsFiltersVisible(){
    return (dispatch,getState)=>{
        ...
        dispatch({
            type:ACTION_SET_IS_FILTERS_VISIVLE,
